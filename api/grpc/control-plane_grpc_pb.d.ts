...
interface IControlPlaneService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  getMovieDetail: grpc.MethodDefinition<control_plane_pb.GetMovieDetailsRequest, control_plane_pb.MovieDetail>;
...
export interface IControlPlaneServer extends grpc.UntypedServiceImplementation {
  ...
  getMovieDetail: grpc.handleUnaryCall<control_plane_pb.GetMovieDetailsRequest, control_plane_pb.MovieDetail>;
...
export class ControlPlaneClient extends grpc.Client {
  ...
  getMovieDetail(argument: control_plane_pb.GetMovieDetailsRequest, callback: grpc.requestCallback<control_plane_pb.MovieDetail>): grpc.ClientUnaryCall;
  getMovieDetail(argument: control_plane_pb.GetMovieDetailsRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<control_plane_pb.MovieDetail>): grpc.ClientUnaryCall;
  getMovieDetail(argument: control_plane_pb.GetMovieDetailsRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<control_plane_pb.MovieDetail>): grpc.ClientUnaryCall;
